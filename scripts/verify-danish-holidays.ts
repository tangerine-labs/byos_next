...
import {
	...
	getHolidayName,
	isDanishHoliday,
} from "../app/(app)/recipes/screens/color-calendar/holidays";
...
// Easter 2024-03-31 → Anden påskedag on 2024-04-01
assert(
	isDanishHoliday(2024, 4, 1, m2024),
	"2024-04-01 should be Anden påskedag",
);
assert(
	getHolidayName(2024, 4, 1, m2024) === "Anden påskedag",
	"2024-04-01 name",
);
...
// Curated set excludes common observances
assert(!isDanishHoliday(2024, 5, 1, m2024), "2024-05-01 not a red day (1. maj)");
assert(!isDanishHoliday(2024, 2, 12, m2024), "2024-02-12 not a red day (Fastelavn)");
